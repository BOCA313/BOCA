...
def get_objective_score(independent):
    ...
    cmd2 = ###compile a progrm with generated configuration###'gcc -O2 ' + ' '.join(independent) + ' -I utilities -I linear-algebra/kernels/3mm utilities/polybench.c linear-algebra/kernels/3mm/3mm.c -lm -DPOLYBENCH_TIME -o 3mm_time'
